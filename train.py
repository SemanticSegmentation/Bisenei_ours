...
def main(params):
    ...
    #parser.add_argument('--data', type=str, default='/home/charel/桌面/BiSeNet-master/CamVid', help='path of training data')
    ...
    if args.pretrained_model_path is not None:
        ...
        ############
        #############
        #temp=model.module.load_state_dict(torch.load(args.pretrained_model_path))
        #print(model)
        ##############
        print('Done!')
...
if __name__ == '__main__':
    params = [
        ...
        ###################
        #'--pretrained_model_path','./checkpoints/epoch_25.pth'
    ]
    main(params)
